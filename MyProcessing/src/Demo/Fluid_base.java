...
public class Fluid_base extends PApplet {
	
	
	public static void main (String... args) { 
		Fluid_base pt = new Fluid_base(); 
     PApplet.runSketch(new String[]{"Fluid_base"}, pt); 
    }
	...
	private class MyFluidData implements DwFluid2D.FluidData{
	  ...
	  public void draw() {    
	    ...
	    if(DISPLAY_FLUID_VECTORS){
	      ...
	      //fluid.renderFluidTextures(pg_obstacles, DISPLAY_fluid_texture_mode);
	    }
